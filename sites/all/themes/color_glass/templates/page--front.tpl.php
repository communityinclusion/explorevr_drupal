...
<!-- Render the Content dark orange Region -->
<?php print _bootstrap_region_render($page['home_features2'], 'home_features2', 'div', 'home-features2', 'home-features2 home-section'); ?>
<!-- Render the Content dark orange Region -->
<?php print _bootstrap_region_render($page['home_features3'], 'home_features3', 'div', 'home-features3', 'home-features3 home-section'); ?>
<!-- Render the Content dark orange Region -->
<?php print _bootstrap_region_render($page['home_features4'], 'home_features4', 'div', 'home-features4', 'home-features4 home-section'); ?>
...
print _bootstrap_region_render($page['footer_copyright'], 'footer_copyright', 'div', 'footer-copyright', 'footer-copyright');
?>
</footer>
