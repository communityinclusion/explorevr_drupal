...
function color_glass_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['contents']['home_features'] = array(
    ...
    $form['contents']['home_features2'] = array(
    '#title' => t('Content for Home page Features2 Area'),
    '#description' => t('Content for Home page Features2 Area. Use &lt;disable&gt; to disable this region.'),
    '#default_value' => _bootstrap_helper_theme_get_setting('home_features2') ,
    '#type' => 'textarea',
    '#required' => FALSE,
  );
  $form['contents']['home_features3'] = array(
    '#title' => t('Content for Home page Features3 Area'),
    '#description' => t('Content for Home page Features3 Area. Use &lt;disable&gt; to disable this region.'),
    '#default_value' => _bootstrap_helper_theme_get_setting('home_features3') ,
    '#type' => 'textarea',
    '#required' => FALSE,
  );
  $form['contents']['home_features4'] = array(
    '#title' => t('Content for Home page Features4 Area'),
    '#description' => t('Content for Home page Features4 Area. Use &lt;disable&gt; to disable this region.'),
    '#default_value' => _bootstrap_helper_theme_get_setting('home_features4') ,
    '#type' => 'textarea',
    '#required' => FALSE,
  );
